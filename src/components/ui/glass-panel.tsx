  ...
  ({ className, children, glassColor, variant = "default", hoverScale = false, ...props }, ref) => {
    ...
    return (
      <>
        ...
        <div
          ref={ref}
          className={cn(`glass-panel-${filterId} rounded-2xl overflow-hidden`, className)}
          {...props}
        >
          {children}
        </div>
